...
interface WeeklyBudgetUpdateEmailProps {
  username: string;
  startDate: string;
  endDate: string;
  totalIncome: string;
...
export const WeeklyBudgetUpdateEmail: React.FC<WeeklyBudgetUpdateEmailProps> = ({
  username,
  startDate,
  endDate,
  totalIncome,
  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        <Text style={heading}>Your Weekly Budget Update for {appName}</Text>
...
export default WeeklyBudgetUpdateEmail;